...
### ★★★★★ EN GÜNCEL (29 Haz gece) — SAYFA-SAYFA İNCELEME BÜYÜK BATCH devam (compact-sonrası İLK BUNU OKU)
**~24 commit, tree temiz.** devam-26 + devam-27 (GELISTIRME-GUNLUGU) = tüm bug+UI+veri-QA. **Biten (kısa):** humanizer (+24 etiket) · arama senkronu · profil renk · paradigma geri bildirim · crosslang/segment sonlu fiil · menü (Öğren çıkar, Harita/Tarih swap) · 9 yardım kutusu · **#53 master 288 PDF-bozukluk** · Profiller (Codex adı + EGIDS skala tıkla-aç) · sayfa temizliği #44-50 (örnekler kaldır, ds18→gerçek kaynak, kognat-ağında-gör kaldır, NÖTR launchpad kaldır) · #43 Analiz (`[]` gizle + Paradigma/Üret kelimeyi taşır) · #44 Paradigma Üret butonu · #50 tablo sütun-sabit + düz numara · Üreteç auto-örnek + zaman fallback. **KÖK NEDEN cevapları:** Üreteç boş üretim=apertium dilden-dile zaman etiketi farkı (#54); humanizer kontrollü-yol garanti+Analiz +24 etiket (#56); Karşılaştır statik≠dinamik segmentasyon (#55). **KALAN:** #31 kaynakça · #39 Harita GeoJSON · #42 Hakkında→ana sayfa · #51 Kaynaklar · #40/#41/#48 kaynak-taşı · #35 flicker · #50 eksen-kutu metni · #54/#55/#56 morfoloji-doğruluk track. **Yayın (yapılacak, C1/C3 sonrası):** site Cloudflare Pages + API HF Space/Cloud Run önünde Cloudflare. **DOKUNULMAZ:** Öğren + Araştırmacı Merkezi (ileride büyük güncelleme).
