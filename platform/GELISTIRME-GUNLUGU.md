...
- **`profiles_deep` 14→29.** Her batch ayrı commit, Claude_Preview doğrulamalı (Özbekçe/Kırım Tatar/Gagavuz/Dolganca 4 bölüm render). **Kalan ~18:** tarihsel diller (ds16/14) + Eynu/İli/Urum (ds9'da var, sıradaki) + dedicated-kaynaksızlar özet-only.
