...
> **★ BÖLÜM B ~BİTTİ:** Bölüm A ✅ · master 47 ✅ · harita/atlas/zoom ✅ · profiller base 47 + derin 39 ✅ · Uzaklık 32 ✅ · Kognat 18-dil + Ses denklikleri 7-izogloss ✅ · TTS 14→39 ✅ · **Ekosistem keşif + Profil A1 selektör ✅**. **Kalan:** 8 küçük lehçe derin (kaynaksız→bloke) · (ops.) Kognat 254 kavram (kullanıcı onayı bekliyor). **Sonra Bölüm C (altyapı: ses motoru / üretim arayüzü / HfApi-CRON) → D (eğitim portalı).** Felsefe korundu, her adım commit+push.
