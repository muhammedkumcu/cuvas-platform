...
> **★ BÖLÜM B İLERLEME:** Bölüm A (A1-A6) ✅ · master 47 ✅ · harita/atlas/zoom ✅ · Dil Profilleri base 47 + derin 39/47 ✅ · Uzaklık 10→32 ✅ · **Kognat 18-dil + Ses denklikleri 7-izogloss ✅ (ds17/18)** · **TTS 14→39 ✅ (ds6)**. **Sıradaki: Ekosistem yeni diller → kalan 8 küçük lehçe + selektör → (ops.) Kognat 254 kavram.** Felsefe korundu (faithful+atıflı, kaynaksız=özet-only, uydurma yok), her adım commit+push.
