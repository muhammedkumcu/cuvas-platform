...
- **Paper notu:** master envanteri = yatay ölçeğin tek-otoriteli temeli; çapraz-kontrol (canlı→Glottolog / tarihsel→ds11) kararı kaynak-güvenilirliği farkındalığını gösterir (uydurma yok). Açgözlü etiket-yerleştirme = ölçeklenebilir bir kartografik declutter.
