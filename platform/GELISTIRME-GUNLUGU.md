...
> **★ BU OTURUMUN ÖZETİ (compact öncesi):** Bölüm A (A1-A6) ✅ · Bölüm B: master 47 ✅ · harita/atlas/zoom ✅ · Dil Profilleri base 47 + derin 39/47 ✅ · Uzaklık 10→32 ✅. **Sıradaki: Kognat+Ses denklikleri (ds17/18) → TTS 14→47 → Ekosistem → kalan küçük lehçeler.** Felsefe korundu (faithful+atıflı, kaynaksız=özet-only, uydurma yok), her adım commit+push.
