...
- **⏳ KALAN (ayrı, dikkatli):** `кӗнеки`/`кӗнекинче` tipi — 3.tekil iyelik `-и-` sahte "ses değişimi/nom" olarak yutuluyor (px3sp morfemi görünmüyor). Ünlü düşmesi/uyumla karışma riski yüksek → odaklı pas + `segment_eval` ile yapılmalı.
